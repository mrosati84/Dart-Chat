...
///
/// This is a handy way to call jQuery from
/// Dart. This makes possible to call jQuery
/// methods simply calling:
/// jQuery.callMethod('methodName', ['parameterName']);
/// When jQuery method chaining is needed though, we
/// prefer to call the JS interop this way:
///
/// context
